...
Nm_sites <- read.table('/no_backup/enovoa/nextflow_outputs/human_rRNA_cancer_ivan/heidelberg_lung_samples/comparison_classifiers_08082024/nm_modifications.txt', header = T)

merged2 <- merge(Nm_sites, merged, by="position")
...
# Save the plot
pdf("ROC_curves_classifiers_Nms_23082024.pdf", height = 8, width = 8)
print(p)
dev.off()
